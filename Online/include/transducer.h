...
namespace CPSGrader {
    ...
    public:
        ...
        //cau is neutral causation, cau_up violation distance, cau_low satisfaction distance
        Signal cau, cau_up, cau_low;
        ...
        virtual double compute_causation_mid_upper(double start_time, double current_time){return 0;}
        virtual double compute_causation_mid_lower(double start_time, double current_time){return 0;}

        virtual double causation_opt_upper(){return 0;}
        virtual double causation_opt_lower(){return 0;}

        //ugly way
        virtual int get_index(){return 0;};
        virtual double get_value(){return 0.0;};

        bool double_equals(double a, double b)
        {
            return abs(a - b) < (Signal::RefreshRate/10);
        }
        
        bool double_greater(double a, double b)
        {
            return a - b > (Signal::RefreshRate/100);
        }

        bool double_less(double a, double b)
        {
            return b - a > (Signal::RefreshRate/100);
        }

        bool double_ge(double a, double b)
        {
            return (double_equals(a, b)|| double_greater(a, b));
        }

        bool double_le(double a, double b)
        {
            return (double_equals(a, b)|| double_less(a, b));
        }
...
//         }
    ...
    public:
        ...
        double compute_causation_mid_upper(double tau, double b);
        double compute_causation_mid_lower(double tau, double b);

        double causation_opt_upper();
        double causation_opt_lower();
